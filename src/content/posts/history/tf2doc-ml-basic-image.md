...
description: >-
  TensorFlow2文档，TensorFlow2.0文档，TensorFlow2.0 TF2.0 TensorFlow 2 / 2.0 官方文档中文版，图像分类 Classify images，示例使用 Fashion MNIST
  数据集。
date: '2019-07-09 08:30:10'
tags:
  - TensorFlow 2
  - 官方文档
book: history
...
status: done
draft: false
cover: tf2doc-ml-basic-image/fashion-mnist-sm.jpg
---
