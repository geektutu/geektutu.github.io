...
description: >-
  TensorFlow2文档，TensorFlow2.0文档，TensorFlow2.0 TF2.0 TensorFlow 2 / 2.0 官方文档中文版，过拟合与欠拟合 Explore overfitting and
  underfitting，示例使用 IMDB 影评数据集。
date: '2019-07-12 09:10:10'
tags:
  - TensorFlow 2
  - 官方文档
book: history
...
status: done
draft: false
cover: tf2doc-ml-basic-overfit/imdb.jpg
---
